	  ...
	  _createClass(Effect, [{
	    ...
	    value: function apply(oCtx) {
	      ...
	      for (; j < iLength; j += 4) {
	        ...
	        aResult = this.callBack.call(this, oImageData.data[j + 0], oImageData.data[j + 1], oImageData.data[j + 2], oImageData.data[j + 3]);

	        oImageData.data.set(aResult, j);
	        //oImageData.data.splice.apply( oImageData.data, aResult);
	      }
